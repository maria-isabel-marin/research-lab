...
OUTDIR = Path("outputs_conflicto_contenido")
OUTDIR.mkdir(exist_ok=True, parents=True)

# Palabras clave para "contiene paz"
# Puedes ampliar con 'pacificación', 'pacífica', etc. o usar REGEX si te conviene.
KEYWORDS = ["conflicto", "violencia", "miedo", "guerra", "horror", "hambre", "odio", "sufrimiento"]     # se buscan en expresión, metáfora y dominio_meta
...
fig_sankey.update_layout(
    title=dict(text="Sankey — Metáforas del 'conflicto'", x=0.5),
    font=dict(size=10),
