...
OUTDIR = Path("outputs_paz_contenido")
OUTDIR.mkdir(exist_ok=True, parents=True)

# Palabras clave para "contiene paz" (busca en expresión, metáfora y dominio_meta)
KEYWORDS = [
    "paz", "reconciliación", "diálogo", "esclarecer", "esclarecimiento",
    "memoria", "verdad", "convivencia"
]
...
MAX_SOURCES_PER_TARGET = None   # 0 o None = sin límite
...
fig_sankey.update_layout(
    title=dict(text="Sankey — Metáforas de 'la paz'", x=0.5),
    font=dict(size=10),
